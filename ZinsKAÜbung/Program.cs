...
namespace ZinsKAÜbung
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double KZinsen = 0; double Bilanz = 0; double neu_Kapital = Kapital; double Zinsen = 0;
            ...
            for (int i = 1; i <= Anlagedauer; i++)
            {
                ...
                Console.WriteLine("{0,3} {1,9:F2}$ {2,7:F2}$ {3,9:F2}$ {4,9:F2}$", i, neu_Kapital, Zinsen, KZinsen, Bilanz);
